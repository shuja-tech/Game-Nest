...
function updateBoardDimensions() {
    ...
    playerWidth = Math.floor(10 * dims.scale);
    playerHeight = Math.floor(50 * dims.scale);
    player1.x = Math.floor(10 * dims.scale);
    player1.y = boardHeight/2;
    player1.width = playerWidth;
    player1.height = playerHeight;
    player2.x = boardWidth - playerWidth - Math.floor(10 * dims.scale);
    player2.y = boardHeight/2;
    player2.width = playerWidth;
    player2.height = playerHeight;
    
    ballWidth = Math.floor(15 * dims.scale);
    ballHeight = Math.floor(10 * dims.scale);
